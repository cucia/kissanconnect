...
<div class="container" id="rewards"><br/><br/><br/>
        ...
        <div class="col-sm-10" id="body">
            <center>
                <h4 style="color:#119421">Change Your Password - Kissan Connect</h4><br/>
                <style>
                    #input 
                    { height:4em; }
            ...
            <center>
                <table style="width:50%;">
                            <tr><td>
                                    ...
                                    <input type="password" name="pass" placeholder="Enter New Password" required="" class="form-control" id="input"/><br/>
                        </td></tr>
                </table>                            <center><input type="submit" name="reg" value="Change" class="btn btn-success btn-group-justified" id="btn"/></center>
...
if(isset($_POST["reg"])){
    ...
    if(mysql_query("update tbl_login set password='$pass' where username='$email'")==1){
        
        echo "<script>alert('Password Changed');location.href='index.php';</script>";
        
    }
    else
    {
         echo "<script>alert('Password Changing Failed');location.href='forgot.php';</script>";
    }
