...
<!----->
        <nav class="navbar-default navbar-static-top" role="navigation">
             <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <h1> <a class="navbar-brand"  href="index.html">Kissan Connect </a></h1>         
			   </div>
			 <div class=" border-bottom">
        	<div class="full-left">
        	 
                    <h4 style="float:right;">Admin's Dashboard</h4>
		   ...
		   <!-- Collect the nav links, forms, and other content for toggling -->
			...
			<div class="clearfix">
                     ...
                     <style>
                         #link{ color:red;text-align:center;font-size:1.2em;padding-top:.5em;padding-bottom:.5em; }
                         #link:hover { color:#000; }
                     </style>
                     <div class="navbar-default sidebar" role="navigation" style="margin-top:1em;">
                <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
				
                    <li>
                        <a href="approveexpert.php" id="link">Expert Approval</a>
                    </li>
                   
                    <!--<li>
                        <a href="approveshop.php" id="link">Shop Approval</a>
                    </li>-->
                    <li>
                        <a href="approvefindings.php" id="link">Findings Approval</a>
                    </li>
                    <!-- <li>
                         <a href="viewoffers.php" id="link">Offers</a>
                    </li>-->
                     <li>
                         <a href="avaiservices.php" id="link">Services</a>
                    </li>
                     <li>
                         <a href="viewfeedbacks.php" id="link">User Feedbacks</a>
                    </li>
                     <li>
       ...
       <div class="content-main">
		...
		<!--<div id="owl-demo" class="owl-carousel text-center">
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="slider/na.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="slider/na1.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="slider/na2.jpg" alt="name">
			</div>
			<div class="item">
				<img class="lazyOwl img-responsive" data-src="slider/na.jpg" alt="name">
			</div>
