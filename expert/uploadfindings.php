            ...
            <center>
                <table style="width:40%;">
                            <tr><td>
                                    ...
                                    <input type="file" name="fnote" class="form-control"  required=""/><p>(File format must be pdf or doc)</p><br/><br/>
...
if(isset($_POST["upload"])){
     ...
     $folder='../findings/';
      ...
      if(mysqli_query($conn,$q)==1){
          echo "<script>alert('Findings Uploaded Successfully')</script>";
      }
 else {
