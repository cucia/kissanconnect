		...
		<ul class="nav navbar-nav linkEffects linkHoverEffect_11 custom-menu">
                    ...
                    <li >
                         <form  method="post" action="search.php">
                             <input  type="text" value="" name="search" align="Search" placeholder="Enter farmer's full name" required><br><br>
                             <center><input type="submit" class="btn-primary" name="submit" value="Search"></center>
                         </form></li>
		</ul>
	</div>
	</div>
        ...
        $q2="SELECT * FROM `tbl_query`"
              ...
              $conn= mysqli_connect("localhost","root","","db_kissanconnect");  
                ...
                while($row=  mysqli_fetch_array($res)){
                    ...
                    echo "<h5 style='float:right;'>Already Replied</h5><br>";
                    echo "<a href='viewreplies.php?id=$row[qid]' style='float:right;'>View Reply</a><br>";
                }
                ?></ul>
