...
if(mysqli_num_rows($res1)>0){
    ...
    echo "<script>alert('Email Or Contact Already Exist')</script>";
      ...
      if(mysqli_query($conn,$q2)==1){
       ...
       if(mysqli_query($conn,$q5)==1){
           
            echo "<script>alert('Regisration Success.Please Wait For Admin Approval.Then login using Email address and Contact number.');</script>";
